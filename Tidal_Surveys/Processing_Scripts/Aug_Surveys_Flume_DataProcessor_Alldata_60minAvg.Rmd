...
#exo_files2 <- list.files(path = "C:/Users/wilsonsj/Dropbox (Smithsonian)/GCREW_LOGGERNET_DATA", 
            #           pattern = "GCREW_MARSH_OUTLET_ExoTable_202402", 
           #            all.files = FALSE)
...
read_exo <- function(path){
  ...
  read_delim(path, skip = 1) %>% 
    ...
    mutate(datetime_15min = floor_date(datetime_raw, "60 min")) %>% ## Use me if you want 7:10 = 7:15 and 7:16 = 7:30
...
#sontek_files2 <- list.files(path = "C:/Users/wilsonsj/Dropbox (Smithsonian)/GCREW_LOGGERNET_DATA", 
  #                          pattern = "GCREW_MARSH_OUTLET_SontekTable_202402", 
  #                          all.files = FALSE)
...
#flux2 <- list.files(path = "C:/Users/wilsonsj/Dropbox (Smithsonian)/GCREW_LOGGERNET_DATA", 
      #                 pattern = "GCREW_MARSH_OUTLET_FLUX_202402", 
      #                 all.files = FALSE)
...
#rad_files2 <- list.files(path = "C:/Users/wilsonsj/Dropbox (Smithsonian)/GCREW_LOGGERNET_DATA", 
      #                 pattern = "GCREW_MARSH_OUTLET_Rad7Table_202402", 
      #                 all.files = FALSE)
...
#write.csv(dat, "AugSurvey_ContinuousData_60min.csv")
...
P1 <-  ggplot() + 
    geom_line(data=dat, aes(x=datetime_15min, y=C_CH4_nM/5, color="CH4"), linewidth=0.75) +
    geom_line(data=dat, aes(x=datetime_15min, y=Rad_w_Bqm3, color="Radon"), linewidth=0.75) + 
