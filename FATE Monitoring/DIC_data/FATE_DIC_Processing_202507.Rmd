...
author: "2025 Early Summer Samples"
date: "`r Sys.Date()`"
output: 
  pdf_document:
    toc: true
...
###### Run information - PLEASE CHANGE
  Date_Run = "5/26/25"  #Date that instrument was run
  Run_by = "Stephanie J. Wilson"  #Instrument user 
  Script_run_by = "Stephanie J. Wilson" #Code user 
  run_notes = "No duplicates were included with this run."  #any notes from the run
...
#file path and name for raw summary data file 
    raw_file_name = "Raw Data/FATE_DIC_202507.txt" 
    
#file path and name for raw all peaks file 
    raw_allpeaks_name = "Raw Data/FATE_DIC_202507_allpeaks.txt"

#file path and name of processed data file 
    processed_file_name = "Processed Data/FATE_Processed_DIC_202507.csv"
...
chks_raw <- chks_raw %>%
  filter(!sample_name == "Chk_Std_CRM-221") %>%
  filter(!sample_name == "Chk_Std_CRM-215") %>%
